  ...
  return (
    <div style={{ 
      ...
      <div style={{
        ...
        <h2 style={{ color: '#0F1E3A', marginBottom: '30px', textAlign: 'center' }}>Login</h2>
        ...
        <p style={{ textAlign: 'center', marginTop: '20px', color: '#666' }}>
          Don't have an account? <span style={{ color: '#2D6CDF', cursor: 'pointer' }} onClick={() => navigate('/register')}>Register</span>
        </p>
      </div>
    </div>
  );
